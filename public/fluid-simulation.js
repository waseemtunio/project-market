...
`
  ...
  // Generate a random color for the pointer
  // The color is generated in a way that it is not too bright
  // to avoid overwhelming the fluid simulation with too much color.
